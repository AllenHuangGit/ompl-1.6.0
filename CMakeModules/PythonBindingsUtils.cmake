...
# message(WARNING "PYTHON_FOUND: ${PYTHON_FOUND}")
# message(WARNING "Boost_PYTHON_LIBRARY: ${Boost_PYTHON_LIBRARY}")
# message(WARNING "PY_PYPLUSPLUS: ${PY_PYPLUSPLUS}")
# message(WARNING "PY_PYGCCXML: ${PY_PYGCCXML}")
# message(WARNING "CASTXML: ${CASTXML}")
...
function(create_module_target module)
    ...
    # file(GLOB ALL_FILES "${CMAKE_CURRENT_BINARY_DIR}/bindings/*.h")
    # message(STATUS "All files in directory: ${ALL_FILES}")
    aux_source_directory("${CMAKE_CURRENT_BINARY_DIR}/bindings/${module}" PY${module}BINDINGS)
    # file(GLOB PY${module}BINDINGS "${CMAKE_CURRENT_BINARY_DIR}/bindings/${module}.h")
    # message(STATUS "CMAKE_CURRENT_BINARY_DIR: ${CMAKE_CURRENT_BINARY_DIR}/bindings")
    # message(STATUS "PY${module}BINDINGS: ${PY${module}BINDINGS}")
    ...
    if(NUM_SOURCE_FILES GREATER 0)
        ...
        # message(STATUS "NUM_SOURCE_FILES: ${NUM_SOURCE_FILES}")
        if(PY_OMPL_GENERATE)
